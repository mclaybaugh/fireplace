...
if ( ! function_exists( 'fireplace_setup' ) ) :
    ...
    function fireplace_setup() {
         ...
         * If you're building a theme based on fireplace, use a find and replace
         * to change 'fireplace' to the name of your theme in all the template files.
         */
        load_theme_textdomain( 'fireplace', get_template_directory() . '/languages' );
...
function fireplace_scripts() {
    ...
    wp_style_add_data( 'fireplace-style', 'rtl', 'replace' );

    wp_enqueue_script( 'fireplace-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
